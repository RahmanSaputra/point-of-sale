...
include "koneksi.php";
    ...
    $query ="SELECT id_transaksi, SUM( harga * qty ) AS Total
FROM transaksi";
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Cell(25,1,'Total Uang Didapat','TBLR',0,'C',1); //TBLR (untuk garis)=> B = Bottom,
            // L = Left, R = Right
    ...
    $pdf->Cell(14,1,'ID','LRTB',0,'C');
	$pdf->Cell(10,1,'Total Uang','LRTB',0,'C');
    $pdf->Ln();
